...
namespace Ecommerce_MVC_Core.Migrations
{
    ...
    [Migration("20200701181214_add_Enitys_to_Man_WebSite_mig")]
    partial class add_Enitys_to_Man_WebSite_mig
    {
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 7, 1, 19, 12, 14, 241, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.ProductLikes", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 7, 1, 19, 12, 14, 218, DateTimeKind.Local));
