...
namespace Ecommerce_MVC_Core.Migrations
{
    ...
    [Migration("20200708193102_add_newcolumn_Category_in_enity_Products")]
    partial class add_newcolumn_Category_in_enity_Products
    {
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 7, 8, 20, 31, 2, 576, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.ProductLikes", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 7, 8, 20, 31, 2, 561, DateTimeKind.Local));
