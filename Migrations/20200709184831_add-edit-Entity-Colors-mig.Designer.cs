...
namespace Ecommerce_MVC_Core.Migrations
{
    ...
    [Migration("20200709184831_add-edit-Entity-Colors-mig")]
    partial class addeditEntityColorsmig
    {
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 7, 9, 19, 48, 31, 425, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Ecommerce_MVC_Core.Models.Admin.ProductLikes", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 7, 9, 19, 48, 31, 408, DateTimeKind.Local));
